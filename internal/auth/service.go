...
func New(ttl time.Duration, now func() time.Time, repositories ...Repository) *Service {
	...
	service := &Service{
		users: map[string]User{
			"prosecutor": {ID: "u-prosecutor", Username: "prosecutor", PasswordHash: hashPassword("prosecutor-demo"), Role: RoleProsecutor},
			"regulator":  {ID: "u-regulator", Username: "regulator", PasswordHash: hashPassword("regulator-demo"), Role: RoleRegulator},
			"operator":   {ID: "u-operator", Username: "operator", PasswordHash: hashPassword("operator-demo"), Role: RoleOperator},
			"inspector":  {ID: "u-inspector", Username: "inspector", PasswordHash: hashPassword("inspector-demo"), Role: RoleInspector},
		},
